...
import { productsApi, workCentersApi, scheduleApi, syncApi, settingsApi } from '../lib/api';
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  }, [refreshProducts, refreshWorkCenters, refreshGantt, refreshSummary, refreshSettings]);
  ...
  }, [user, refreshAll, refreshProducts, refreshSummary, settings?.syncIntervalSeconds]);
