...
export default function Layout() {
  const { user, signOut, isPlanner, isAdmin } = useAuth();
  const { syncing, recalculating, triggerSync, recalculateSchedule, lockedJobsAffected, clearLockedJobsNotification } = useData();
