    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Production scheduling powered by Google Sheets
            </p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="text-sm text-gray-500 text-center">
              ...
              <div className="flex justify-center gap-4">
                <span className="px-2 py-1 bg-gray-100 rounded text-xs">Viewer</span>
                <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs">Planner</span>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Connected to your organization's Google Sheets
        </p>
      </div>
    </div>
  );
