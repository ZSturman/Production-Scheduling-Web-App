...
// Simple Gantt chart component (can be replaced with frappe-gantt or other library)
function GanttChart({ data }: { data: NonNullable<ReturnType<typeof useData>['ganttData']> }) {
  ...
  const getTaskPosition = (task: typeof data.workCenters[0]['tasks'][0]) => {
